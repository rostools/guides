...
package creates an issue to help manage the course that includes
a checklist of things to do. Check the r3admin package for documentation 
on it. A basic checklist to prepare for or have for the course is:

-   Bring colourful origami hats (for the laptops) or post-it notes
    for participants to let us know how they are doing.
